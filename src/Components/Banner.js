    ...
    <>
      ...
      <div className='description'>
        <p>
          ...
          current research interests are in simplifying machine learning algorithms, designing
          interpretable-by-design methods, and explainable artificial intelligence. I am currently
          ...
          B.S. and M.S. degrees in Computer Science with a minor in Mathematics from CSU. And some
          fun facts: I enjoy astrophotography, exploring the mountains, and listening to all kinds
          of music from electronic avant-garde to classic rock.
        </p>
      </div>
      <br />
      <br />
